...
$this->menu = array(
    array('label' => 'List Of Groups', 'url' => array('groupMembers/index')),
    array('label' => 'Add Friends to Group', 'url' => array('groupMembers/create')),
    array('label' => 'Create New Group', 'url' => array('groups/')),
...
<section id="tables">
    ...
    <?php echo CHtml::submitButton("Add Members to Group", array("style" => 'padding:5px 10px;', "id" => "send_invite")); ?>
