                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse" id="main-menu">
                        <ul class="nav" id="main-menu-left">
                            <li><a onclick="pageTracker._link(this.href);
                return false;" href="http://news.bootswatch.com/">News</a></li>
                            ...
                            <li class="dropdown" id="preview-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a target="_blank" href="http://bootswatch.com/amelia/bootstrap.min.css">bootstrap.min.css</a></li>
                                    <li><a target="_blank" href="http://bootswatch.com/amelia/bootstrap.css">bootstrap.css</a></li>
                                    <li class="divider"></li>
                                    <li><a target="_blank" href="http://bootswatch.com/amelia/variables.less">variables.less</a></li>
                                    <li><a target="_blank" href="http://bootswatch.com/amelia/bootswatch.less">bootswatch.less</a></li>
                                </ul>
                            </li>
                        </ul>
                        <ul class="nav pull-right" id="main-menu-right">
                            <li><a data-original-title="Showcase of Bootstrap sites &amp; apps" rel="tooltip" target="_blank" href="http://builtwithbootstrap.com/" title="" onclick="_gaq.push(['_trackEvent', 'click', 'outbound', 'builtwithbootstrap']);">Built With Bootstrap <i class="icon-share-alt"></i></a></li>
                            <li><a data-original-title="Marketplace for premium Bootstrap templates" rel="tooltip" target="_blank" href="https://wrapbootstrap.com/?ref=bsw" title="" onclick="_gaq.push(['_trackEvent', 'click', 'outbound', 'wrapbootstrap']);">WrapBootstrap <i class="icon-share-alt"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="well" style="padding: 15px 15px 0 15px;">
                            <a href="http://carboncostume.com/apple-store-genius/" target="_blank">
                                <span style="float: left; margin: 0 15px 15px 0;">
                                    <img src="Bootswatch:%20Amelia_files/carboncostume.png" style="border-radius: 5px;" height="135" width="175">
                                </span>
                            </a>
